...
{
	public class TutorialWindow_Ship2 : MonoBehaviour
	{
		...
		public RulesControlShip2 rulesControlShip2;
		...
		private IEnumerator Tutorial_Play_Yield()
		{
			...
			yield return (StartCoroutine(rulesControlShip2.Access_WaitForRulesToFinish()));
